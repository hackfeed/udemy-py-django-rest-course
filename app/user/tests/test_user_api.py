...
class PublicUserAPITests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {"email": "testhackfeed@hackfeed.com",
                   "password": "testpass"}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {"email": "testhackfeed@hackfeed.com", "password": "tp"}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email="testhackfeed@hackfeed.com", password="testpass")
        payload = {"email": "testhackfeed@hackfeed.com",
